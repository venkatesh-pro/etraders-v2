      ...
      >
        <div className="text-[#F7F7F7] mx-[20px] md:mx-[48px] w-full flex  items-center flex-col pt-[100px] pb-[100px] md:pt-[120px] md:pb-0">
          ...
          <div className="flex mt-[24px]">
            ...
            <Link target="_blank" href={'/spaceone/dimensioned-plans.pdf'} className="flex items-center justify-center rounded-[100px] ml-[16px] min-w-[151px] max-w-[151px] bg-white text-black text-[14px] min-h-[41px] font-[400] max-h-[41px] text-center hover:opacity-[90%] transition-opacity duration-300 tracking-[.5px]">
              Compare Models
            </Link>
          </div>
        </div>
