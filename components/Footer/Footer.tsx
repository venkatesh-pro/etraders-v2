...
const Footer = () => {
  return (
    <div className="px-[20px] md:px-[48px] py-[40px] text-white min-h-[385px] md:h-full  bg-black">
      <ul className="text-[#949192] text-[12px] font-[400] list-decimal ml-[12px]">
        <li>
          ...
          fees. Your applicable taxes and fees will be confirmed for you closer
          to time of delivery. Early termination fees apply. Fees may be charged
          for excessive wear plus any overage of damage. Late payments will
          incur a 5% fee. Lease does not include maintenance or insurance.
          Complete terms will be included in Modular Building Lease Agreement.
        </li>
      </ul>
